...
public class LocalizationManager : MonoBehaviour  {
    ...
    private static Dictionary<string, string> RU = new Dictionary<string, string> {
        ...
        { "ObjectNotSlicable", "{0} не нужно нарезать"},
        ...
        { "ProductNotFryible", "{0} нельзя пожарить!"},
        ...
        { "StepRightButton", "Кнопка справа (E, русская У) используется чтобы что-то брать или класть" },
        { "StepLeftButton", "Кнопка слева (F, русская А) используется, чтобы нарезать продукты или включать духовку" },
        ...
        { "FPress", "Когда соберёшь все ингредиенты запускай духовку на F (русская А)" },
        ...
        { "NotEnoughCoins", "Не хватает коинов" },
        { "NotEnoughGems", "Не хватает гемов" },
        { "PurchaseSuccesfull", "Покупка успешна" },
        
        // Plate
        { "PizzaAlreadyOnTray", "Пицца уже лежит на подносе" },
        { "PizzaIsAdded", "Пицца добавлена на поднос" },
        { "IngredientAddedOrCannot", "Ингредиент уже добавлен или его нельзя добавить" },
        { "DrinkAlreadyOnTray", "Напиток уже лежит на подносе" },
        { "CannotAddInBurger", "Это нельзя положить в бургер" },
        { "NeedSliced", "{0} нужно порезать" },
        { "MeetNeedFried", "Мясо нужно пожарить" },
        { "MeetIsOvercooked", "Мясо пережарилось" },
        { "ItsForJuicer", "Это для соковыжималки" },
        { "ItsForOven", "Это только для духовки" },
     ...
     private static Dictionary<string, string> EN = new Dictionary<string, string> {
        ...
        { "HowPizzaMade", "The pizza is assembled right in the oven, so just put the ingredients right in there !" },
        ...
        { "PurchaseSuccesfull", "Purchase was successful" },
        
        // Plate
        { "PizzaAlreadyOnTray", "The pizza is already on the tray" },
        { "PizzaIsAdded", "Pizza added to the tray" },
        { "IngredientAddedOrCannot", "The ingredient has already been added or cannot be added" },
        { "DrinkAlreadyOnTray", "The drink is already on the tray" },
        { "CannotAddInBurger", "You can't put that in a burger." },
        { "NeedSliced", "{0} need to be chopped" },
        { "MeetNeedFried", "The meat needs to be fried" },
        { "MeetIsOvercooked", "The meat is overcooked" },
        { "ItsForJuicer", "It's for the juicer" },
        { "ItsForOven", "It's only for the oven" },
