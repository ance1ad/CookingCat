...
namespace YG
{
    public class LBPlayerDataYG : MonoBehaviour
    {
        ...
        [SerializeField] private Sprite _defaultPlaceIcon;
        ...
        public void UpdateEntries()
        {
            if (textLegasy.rank && data.rank != null) {
                ...
                // Добавил своего
                if (data.rank == "1") {
                    _imageComponent.sprite = _firstPlaceIcon;
                }
                else if (data.rank == "2") {
                    _imageComponent.sprite = _secondPlaceIcon;
                }
                else if (data.rank == "3") {
                    _imageComponent.sprite = _thirdPlaceIcon;
                }
                else {
                    _imageComponent.sprite = _defaultPlaceIcon;
                }
            }
